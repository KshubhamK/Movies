...
public class PopularMoviesAdapter extends RecyclerView.Adapter<PopularMoviesAdapter.MyViewHolder> {
    ...
    private PopularMoviesAdapter.OnClickInterface onClickInterface;
     ...
     */
    public PopularMoviesAdapter(List<MovieResultModel> latestMoviesList, Activity activity,
                                PopularMoviesAdapter.OnClickInterface onClickInterface)
    {
    ...
    @NonNull
    @Override
    public PopularMoviesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rcv_movies_list, parent, false);

        return new PopularMoviesAdapter.MyViewHolder(itemView);
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull PopularMoviesAdapter.MyViewHolder holder, int position) {
        ...
        if (movieResultModel != null) {
            ...
            File file = new File(movieResultModel.getPoster_path());
    ...
    public int getItemCount() {
        return latestMoviesList == null ? 0 : latestMoviesList.size();
    }
